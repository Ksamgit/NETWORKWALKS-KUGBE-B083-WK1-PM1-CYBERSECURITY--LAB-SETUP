...
This project focuses on setting up a virtual cybersecurity and penetration-testing laboratory using **Oracle VirtualBox 7.2** and **Kali Linux 2026.2**.
...
The lab environment supports on-demand scaling; additional target and testing instances can be dynamically attached to the isolated NAT network without reconfiguring the core infrastructure.
...
- Install and configure Oracle VirtualBox 7.2 .
...
The main host operating system is Windows 11, with oracle VirtualBox 7.2 providing the virtualization environment.
